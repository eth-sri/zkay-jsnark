...
public class ElgamalTest {
    ...
    private static class ElgamalEncCircuitGenerator extends CircuitGenerator {
        ...
        protected void buildCircuit() {
            ...
            ZkayElgamalGadget gadget = new ZkayElgamalGadget(messageBits.asArray(),
    ...
    public void testElgamal1() {
        ...
        oneInputTest(plain, random, new AffinePoint(pkx, pky), new AffinePoint(c1x_exp, c1y_exp), new AffinePoint(c2x_exp, c2y_exp));
    }
